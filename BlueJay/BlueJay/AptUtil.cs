...
namespace BlueJay
{
    class AptUtil
    {
        ...
        public static async Task<List<AirportEntry>> getAirportList()
        {
            ...
            if (error != "")
                MessageBox.Show(error, "Get Airport List Error", MessageBoxButton.OK);
        ...
        public static async Task<List<MonthEntry>> getAirportMonthList(string airportID)
        {
            ...
            if (error != "")
                MessageBox.Show(error, "Get Airport Month List Error", MessageBoxButton.OK);
            ...
            List<Metar> listMorning, List<Metar> listNoon, List<Metar> listAfternoon, List<Metar> listEvening)
        {
            ...
            if (error != "")
                MessageBox.Show(error, "Get Airport Month Data Error", MessageBoxButton.OK);
        }
    }
}
